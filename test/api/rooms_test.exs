defmodule Api.RoomsTest do
  ...
  describe "rooms" do
    ...
    import Api.RoomsFixtures

    @invalid_attrs %{name: nil, is_private: nil}
    ...
    test "create_room/1 with valid data creates a room" do
      valid_attrs = %{name: "some name", is_private: true}
    ...
    test "update_room/2 with valid data updates the room" do
      room = room_fixture()
      update_attrs = %{name: "some updated name", is_private: false}
